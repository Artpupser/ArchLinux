...
CLION="https://download-cdn.jetbrains.com/cpp/CLion-$CURRENT_YEAR.1.3.tar.gz"
IDES_URLS=("$WEB_STORM" "$RIDER" "$PY_CHARM" "$RUST_ROVER" "$IDEA_IU" "$CLION")
IDES=("WebStorm" "Rider" "PyCharm" "RustRover" "IdeaIU" "CLion")
